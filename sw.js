...
const VERSION = "shredlog-v8";
const SHELL = ["./", "./index.html", "./app.js?v=8", "./data.js?v=8", "./backend.js?v=8", "./config.js", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png"];
