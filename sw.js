...
const VERSION = "shredlog-v4";
const SHELL = ["./", "./index.html", "./app.js?v=4", "./data.js?v=4", "./backend.js?v=4", "./config.js", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png"];
