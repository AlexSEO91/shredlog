...
const VERSION = "shredlog-v7";
const SHELL = ["./", "./index.html", "./app.js?v=7", "./data.js?v=7", "./backend.js?v=7", "./config.js", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png"];
